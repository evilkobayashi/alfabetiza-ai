      ...
      <div className="lg:col-span-6 flex flex-col justify-between p-6 sm:p-12">
        ...
        <div className="w-full max-w-md mx-auto my-auto py-6">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-gray-500 mt-2">Comece gratuitamente agora mesmo.</p>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-3xl p-8 shadow-xl">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input type="text" value={name} onChange={(e) => setName(e.target.value)} required
                    className="w-full pl-11 h-12 rounded-xl bg-gray-50 border border-gray-200 text-gray-900 focus:ring-2 focus:ring-sky-500 text-sm font-medium outline-none" placeholder="Seu nome" />
                </div>
              </div>
              <div className="space-y-1.5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} required
                    className="w-full pl-11 pr-11 h-12 rounded-xl bg-gray-50 border border-gray-200 text-gray-900 focus:ring-2 focus:ring-sky-500 text-sm font-medium outline-none" placeholder="Mínimo 6 caracteres" />
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              Já tem conta? <Link href="/login" className="font-bold text-sky-600 hover:underline">Entrar</Link>
            </p>
          </div>
        </div>
        <div />
